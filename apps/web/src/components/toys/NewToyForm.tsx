  ...
  return (
    <form className="space-y-6">
      ...
      <button
        type="submit"
        id="publish-toy"
        className="w-full rounded-xl bg-primary px-6 py-3.5 text-base font-semibold text-white shadow-lg shadow-primary/25 hover:bg-primary-dark transition-all hover:shadow-xl active:scale-[0.98]"
      >
        🧸 {t('toys.publish')}
      </button>
    </form>
