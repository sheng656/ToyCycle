    ...
    <div className="w-full max-w-md animate-fade-in">
      ...
      <div className="bg-surface border border-border rounded-2xl p-8 shadow-card">
        ...
        <form action={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? '注册中...' : t('auth.registerButton')}
          </button>
        </form>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button type="button" id="register-wechat" className="flex items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium hover:bg-surface-elevated transition-colors">
          ...
          <button type="button" id="register-google" className="flex items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium hover:bg-surface-elevated transition-colors">
