        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-card">
          <form className="space-y-5">
            ...
            <button
              type="submit"
              id="register-submit"
              className="w-full rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-dark transition-all hover:shadow-md active:scale-[0.98]"
            >
