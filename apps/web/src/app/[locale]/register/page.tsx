    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12 bg-surface-container-low">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-heading font-bold">{t('auth.registerTitle')}</h1>
          <p className="text-foreground/60 mt-2">{t('auth.registerSubtitle')}</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-card">
          <form className="space-y-5">
            {/* Email */}
            <div>
              <label htmlFor="register-email" className="block text-sm font-bold mb-1.5">
                {t('auth.email')}
              </label>
              <input
                id="register-email"
            ...
            {/* Password */}
            <div>
              <label htmlFor="register-password" className="block text-sm font-bold mb-1.5">
                {t('auth.password')}
              </label>
              <input
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="register-confirm-password" className="block text-sm font-bold mb-1.5">
        ...
        <p className="text-center mt-6 text-sm text-foreground/60">
          {t('auth.hasAccount')}{' '}
          <Link href="/login" className="text-primary font-bold hover:text-primary/70 transition-colors">
            {t('common.login')}
          </Link>
        </p>
      </div>
